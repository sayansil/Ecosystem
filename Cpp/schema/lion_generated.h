...
#ifndef FLATBUFFERS_GENERATED_LION_ECOSYSTEM_LION_H_
#define FLATBUFFERS_GENERATED_LION_ECOSYSTEM_LION_H_
...
inline const Ecosystem::Lion::Base *GetBase(const void *buf) {
  return flatbuffers::GetRoot<Ecosystem::Lion::Base>(buf);
}

inline const Ecosystem::Lion::Base *GetSizePrefixedBase(const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<Ecosystem::Lion::Base>(buf);
}
...
inline Ecosystem::Lion::Base *GetMutableSizePrefixedBase(void *buf) {
  return flatbuffers::GetMutableSizePrefixedRoot<Ecosystem::Lion::Base>(buf);
}

inline bool VerifyBaseBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<Ecosystem::Lion::Base>(nullptr);
}

inline bool VerifySizePrefixedBaseBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<Ecosystem::Lion::Base>(nullptr);
}

inline void FinishBaseBuffer(
    flatbuffers::FlatBufferBuilder &fbb,
    flatbuffers::Offset<Ecosystem::Lion::Base> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_LION_ECOSYSTEM_LION_H_
