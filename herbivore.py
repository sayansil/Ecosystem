...
from helper import random_binary, random_name
...
class Deer(Animal):
    ...
    def __init__(
        ...
        name=None):
        if not name:
            name = Deer.species_name + '-' + random_name()

        super(Deer, self).__init__(name, Deer.species_name, chromosome, Deer.chromosome_structure, generation)
